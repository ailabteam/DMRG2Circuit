...
if __name__ == '__main__':
    run_experiment(L=10, J=1.0, g=0.5, num_layers=4, num_steps=300, step_size=0.05, alpha=0.1)
    run_experiment(L=10, J=1.0, g=1.0, num_layers=6, num_steps=400, step_size=0.05, alpha=0.1)
